...
class ConcatinationString {
    public static void main(String[] args) {
        ...
        // if not assign to s1 after concatenation it will make new string in heap but
        // not reffer to s1
        ...
        // s3 will be created in heap area bcz we use inbuild method concat which will
        // acts as new key word
        ...
        // It will add number as string if passed + with string
